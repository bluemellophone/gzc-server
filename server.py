...
TIME_HOUR = list(map(str, range(0, 24)))
TIME_MINUTE = list(map(str, range(0, 60)))
TRACK_NUMBERS = list(map(str, range(1, 6)))
...
def cards(type=4):
    ...
    return sf.template('cards', page_list=page_list, type=type)
